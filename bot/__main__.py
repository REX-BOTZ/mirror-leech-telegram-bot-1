...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Rex leech zone", "https://t.me/+XRo51n4f3tcxNjFl")
...
'''
        ...
        sendMarkup('Hey, there you cannot use me here join rex leech group to use me', context.bot, update.message, reply_markup)
